...
public:
    ...
    unsigned char *EncryptCustomCTR(const unsigned char in[], unsigned int inLen,
                              const unsigned char key[]);
    ...
    unsigned char *CustomGetRoundKeys(const unsigned char key[]);

    unsigned char *CustomOnlyEncryptECB(const unsigned char in[], unsigned int inLen,
                                         unsigned char roundKeys[]);
    unsigned char *CustomOnlyEncryptCTR(const unsigned char in[], unsigned int inLen,
                                              unsigned char roundKeys[]);
};
